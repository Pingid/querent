...
use crate::schema::FunctionReturnType;
...
pub(crate) static FUNCTIONS: phf::Map<&'static str, SpecFunction> = phf::phf_map! {
    ...
    "ABS" => SpecFunction {
        ...
        return_type: FunctionReturnType::Scalar(DataType::Double),
    ...
    "UPPER" => SpecFunction {
        ...
        return_type: FunctionReturnType::Scalar(DataType::Text),
    ...
    "LENGTH" => SpecFunction {
        ...
        parameter_types: &[DataType::Text],
        return_type: FunctionReturnType::Scalar(DataType::Integer),
    ...
    "CURRENT_DATE" => SpecFunction {
        ...
        parameter_types: &[],
        return_type: FunctionReturnType::Scalar(DataType::Date),
        description: "Returns the current date.",
    },
    "CURRENT_TIMESTAMP" => SpecFunction {
        function_name: "CURRENT_TIMESTAMP",
        parameter_types: &[],
        return_type: FunctionReturnType::Scalar(DataType::Timestamp),
    ...
    "COALESCE" => SpecFunction {
        ...
        return_type: FunctionReturnType::Scalar(DataType::Any),
    ...
    "COUNT" => SpecFunction {
        ...
        return_type: FunctionReturnType::Aggregate(DataType::Integer),
        description: "Counts the number of input rows.",
    },
    "SUM" => SpecFunction {
        function_name: "SUM",
        parameter_types: &[DataType::Double],
        return_type: FunctionReturnType::Aggregate(DataType::Double),
    ...
    "MIN" => SpecFunction {
        function_name: "MIN",
        parameter_types: &[DataType::Any],
        return_type: FunctionReturnType::Aggregate(DataType::Any),
